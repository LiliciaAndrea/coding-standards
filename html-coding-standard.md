...
#### [强制] 使用 `HTML5` 的 `doctype` 来启用标准模式，虽然doctype不区分大小写，但建议使用大写的 `DOCTYPE`。见[is-there-any-benefits-to-use-uppercase-or-lowercase-letters-with-html5-tagname](http://stackoverflow.com/questions/15594877/is-there-any-benefits-to-use-uppercase-or-lowercase-letters-with-html5-tagname)
...
更多信息, 阅读[Stack Overflow](http://stackoverflow.com/questions/6771258/whats-the-difference-if-meta-http-equiv-x-ua-compatible-content-ie-edge-e) 文章.
不同doctype在不同浏览器下的不同渲染模式，[诡异模式](https://hsivonen.fi/doctype/)总结的很到位.
...
通过Sitepoint 得到一个[语言代码列表](http://www.sitepoint.com/web-foundations/iso-2-letter-language-codes/).由于其只是给出了语言代码的大类，比如说中文就只给出了ZH，但是没有区分香港，台湾，大陆等。而微软给出的一份细分了zh-cn,zh-hk,zh-tw[Head to Microsoft for a detail list of language codes](https://msdn.microsoft.com/en-us/library/ms533052%28v=vs.85%29.aspx)
